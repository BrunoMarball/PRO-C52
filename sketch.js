...
function preload(){
  ...
  shooterImg = loadImage("Pana_Miguel.png")
  shooter_shooting = loadImage("Pana_Miguel3.png")

  zombieImg = loadImage("assets/Doge_Fuerte.png")

  bgImg = loadImage("doge_background.png.jpg")

  bulletImg = loadImage("Cheemsburger.png")
...
// Destruir al zombi, al jugador y a las balas; Mostrar un mensaje en el estado de juego gameState "bullet"
  ...
  textSize(50)
  fill("yellow")
  text("¡Te quedaste sin Cheemsburgers!",470,410)
  zombieGroup.destroyEach();
  player.destroy();
  bulletGroup.destroyEach();
